...
<p class="p-form-indent">
    ...
    มีความประสงค์ลาไปช่วยเหลือภริยาโดยชอบด้วยกฎหมายชื่อ
    <span class="text-dashed"><?= $wife_name ?></span> 
    ซึ่งคลอดบุตรเมื่อวันที่ 
    <span class="text-dashed"><?= Yii::$app->formatter->asDate(ThaiYearFormatter::toDb($model->child_birthday)) ?></span>


    <?= (isset($date_range_input) ? "<br/>" . $date_range_input . "<br/>" : 'จึงขออนุญาตลาไปช่วยเหลือภริยาที่คลอดบุตรตั้งแต่ ' . $date_range) ?>
    ...
    <span class="text-dashed"><?= $contact ?></span>

    หมายเลขโทรศัพท์
    <span class="text-dashed"><?= $phone ?></span>
</p>
<br/>
<br/>
