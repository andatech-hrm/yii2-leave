...
class Draft extends Leave
{
    ...
    public function scenarios(){
      ...
      $scenarios['insert'] = ['to','year','leave_type_id','contact','acting_user_id', 'date_start', 'date_end','status','inspector_by','director_by','commander_by','start_part','end_part','contact','number_day'];
