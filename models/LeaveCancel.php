...
class LeaveCancel extends \yii\db\ActiveRecord
{
    ...
    public function scenarios(){
      ...
      $scenarios['commander'] = ['status','commander_status', 'commander_at', 'commander_comment', 'updated_at','updated_by'];
      $scenarios['director'] = ['status','director_status', 'director_at', 'director_comment', 'updated_at','updated_by'];
